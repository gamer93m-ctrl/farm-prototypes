...
const HINTS2 = {
  ...
  direct: {
    hold: 'Ручка стоит на месте, как в версии A. Держишь палец — на ячейке заряжается кольцо; взвелось — ручка улетает на палец, дальше ведёшь и собираешь пачкой.'
  }
};
...
/* ═══════════ V2: ФИДБЕК УДЕРЖАНИЯ (B) И РЕЖИМ ДЁРГАНЬЯ (C) ═══════════
   ...
   пока ведёшь. Она не инструмент, а индикатор: показывает, что сейчас
   идёт массовый сбор.
